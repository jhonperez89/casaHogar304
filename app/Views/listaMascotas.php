    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link fuente" aria-current="page" href="<?=site_url('/mascotas/registros') ?>">registrar productos</a>
          </li>
      ...
      <?php foreach($mascotas as $mascota):?>
        <div class="card" ">
          ...
          <div class="card-body">
            ...
            <a data-bs-toggle="modal" data-bs-target="#editar<?= $mascota["id"] ?>" href="#" class="btn btn-primary"><i class="far fa-edit"></i></a>
          </div>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-9">
                      <form action="<?= site_url('/mascotas/editar/'.$mascota["id"])?>" method="POST">
