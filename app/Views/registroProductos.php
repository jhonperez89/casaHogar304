...
<header>
  ...
  <h2 style="color:#FFFFFF";>Registro De Productos</h2>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-6">
                <div class="form-floating mb-3">
                    ...
                    <div class="form-floating mb-3">
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="precio" placeholder="precio unidad">
                       <label for="floatingPassword">Precio Unidad</label>
                      </div>
                        <div class="form-floatin mb-3">
                          ...
                          <div class="form-floating mb-3">
                            <select class="form-select" name="seleccion" aria-label="">
            ...
            <div class="col-6">
            <img src="<?= base_url('public/img/aninmales.jpg') ?>" class="d-block w-100" alt="...">
